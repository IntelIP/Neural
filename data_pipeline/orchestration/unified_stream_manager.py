...
from data_pipeline.streaming.websocket import KalshiWebSocket as KalshiWebSocketClient
from data_pipeline.data_sources.espn.stream import ESPNStreamAdapter
from data_pipeline.data_sources.twitter.stream import TwitterStreamAdapter
from data_pipeline.data_sources.twitter.sentiment import MarketImpact

# Import new infrastructure components
from data_pipeline.event_buffer import EventBuffer, BufferedEvent, Priority
from data_pipeline.state_manager import get_state_manager, ComputationCache
from data_pipeline.window_aggregator import WindowAggregator

# Import resilience components
from data_pipeline.reliability.resilience_coordinator import (
    get_resilience_coordinator, ServicePriority, DegradationLevel
)
from data_pipeline.reliability.health_monitor import get_health_monitor, websocket_health_check

# Import rate limiting and backpressure components
from data_pipeline.reliability.rate_limiter import HierarchicalRateLimiter
from data_pipeline.reliability.backpressure_manager import BackpressureController, PressureLevel

# Import Redis publisher for agent communication
from data_pipeline.orchestration.redis_event_publisher import RedisPublisher, RedisStreamBridge
...
class StreamManager:
    ...
    async def initialize(self):
        ...
        if kalshi_key_id and kalshi_private_key:
            from data_pipeline.data_sources.kalshi.auth import KalshiAuth
            from data_pipeline.config.settings import KalshiConfig
            ...
            from data_pipeline.message_handler import StreamManagerMessageHandler
