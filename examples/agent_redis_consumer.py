...
async def main():
    ...
    if mode == "data":
        ...
        tasks = [
            asyncio.create_task(run_agent(DataEngineerConsumer, ["kalshi:markets", "kalshi:signals"])),
            asyncio.create_task(run_agent(MarketEngineerConsumer, ["kalshi:markets", "espn:games"])),
