...
## Sports venue research

[Venue access questions and cost-trial preparation](./research/2026-09-10-venue-access-and-cost-plan.mdx) records the permissions, settlement and fee questions required before a retained-data trial. Synthetic paper fixtures may proceed; no live venue selection is claimed.
