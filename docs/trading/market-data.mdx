...
Install `neural-sdk[trading]` before using the WebSocket or FIX clients. The base install is enough for the docs and CLI, but these streaming surfaces live in the trading extra.
...
Whichever route you choose, the snapshots integrate cleanly with the analysis stack and paper trading simulator. Treat FIX as experimental until the supported beta contract expands to cover it.
