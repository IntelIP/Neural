...
This surface is experimental and requires `neural-sdk[trading]`.
...
For the supported public beta path, prefer `TradingClient` plus paper trading first. Use FIX only when you are intentionally operating beyond the stable beta contract.
