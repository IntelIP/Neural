...
- Disconnect cancels pending intent, preserving holdings. Pending orders expire
  ...
  than 30 seconds before observation. Legacy Kalshi replay retains its previous
  source handling. Market opening, queue priority, impact, other traders, actual
...
Legacy Kalshi report shape and content identities remain unchanged.
